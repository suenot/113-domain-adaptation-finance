# Chapter 92: Domain Adaptation для Finance

## Описание

Адаптация моделей к новым рыночным доменам без переобучения.
...
1. **Domain Adaptation for Time Series Forecasting**
   - URL: https://arxiv.org/abs/2203.12501
   - Год: 2022
